...
StateMenu::StateMenu(KaperCanvas* oKaperCanvas) {
  m_oCanvas = oKaperCanvas;

  m_bLocked = true;

  m_oHighscore = nullptr;
  ...
  m_sHighPlayers = std::vector<std::string>(5);
  m_sHighScore = std::vector<std::string>(5);
...
void StateMenu::Draw(Graphics* g) {
  if (m_bFirstTime) {
    ////////////////////////////////////////////////////
    // Check Speed, to determine SpeedOptimze
    ////////////////////////////////////////////////////
    // long long lStart = System::currentTimeMillis();
    ...
    // if (95 < (System::currentTimeMillis() - lStart))
    if (std::chrono::milliseconds(95) <
        std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now() - lStart)) {
      m_oCanvas->m_bSpeedOptimized = true;
    } else {
      m_oCanvas->m_bSpeedOptimized = false;
    }
    ////////////////////////////////////////////////////
    // Check Speed, to determine SpeedOptimze
    ////////////////////////////////////////////////////
  ...
  if (m_bShowInstructions) {
    ...
    m_oCanvas->DrawString("BUT DON'T SINK IT. SAI", 1, 243 - (m_cLineInstructions * 11), false, 1);
    ...
    if (m_iWebRankShow == 1) {
      m_oCanvas->DrawString("Highscore   <Month>", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 2) {
      m_oCanvas->DrawString("Highscore   <Today>", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 3) {
      m_oCanvas->DrawString("Highscore   < All >", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 4) {
      m_oCanvas->DrawString("Highscore100<Month>", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 5) {
      m_oCanvas->DrawString("Highscore100< Day >", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 6) {
      m_oCanvas->DrawString("Highscore100< All >", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 7) {
      m_oCanvas->DrawString("Highscore300<Month>", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 8) {
      m_oCanvas->DrawString("Highscore300<Today>", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    if (m_iWebRankShow == 9) {
      m_oCanvas->DrawString("Highscore300< All >", (m_oCanvas->m_iWidth / 2) - 60, 5, false, 1);
    }
    ...
    if (m_oHighscore->m_cWebDataReady == 2) {
      ...
      for (int i = 0; i < 5; i++) {
        if (m_iWebRankShow == 1) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHighMonPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHighMonScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 2) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHighDayPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHighDayScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 3) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHighAllPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHighAllScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 4) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh100MonPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh100MonScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 5) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh100DayPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh100DayScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 6) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh100AllPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh100AllScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 7) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh300MonPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh300MonScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 8) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh300DayPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh300DayScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
        if (m_iWebRankShow == 9) {
          m_oCanvas->DrawString(std::to_string((i + 1)) + ".", (m_oCanvas->m_iWidth / 2) - 87, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh300AllPlayers[i], (m_oCanvas->m_iWidth / 2) - 65, 20 + (i * 15), false, 1);
          m_oCanvas->DrawString(
              m_oHighscore->m_sWebHigh300AllScore[i], (m_oCanvas->m_iWidth / 2) + 15, 20 + (i * 15), false, 1);
        }
      }
    } else {
  ...
  else // Menu
  {
    ...
    if (45 <= ((m_oCanvas->m_iHeight / 2) - 30 - iScreenMove)) {
      m_oCanvas->DrawString(
          "START NEW GAME", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) - 30 - iScreenMove, false, 1);
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) - 15 - iScreenMove)) {
      if (!m_bAnyContinueGame) {
        m_oCanvas->DrawString(
            "CONTINUE GAME", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) - 15 - iScreenMove, false, 2);
      } else {
        m_oCanvas->DrawString(
            "CONTINUE GAME", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) - 15 - iScreenMove, false, 1);
      }
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) - iScreenMove)) {
      m_oCanvas->DrawString(
          "INSTRUCTIONS", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) - iScreenMove, false, 1);
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) + 15 - iScreenMove)) {
      m_oCanvas->DrawString(
          "LOCAL SCORE", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 15 - iScreenMove, false, 1);
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) + 30 - iScreenMove)) {
      m_oCanvas->DrawString(
          "WEB SCORE", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 30 - iScreenMove, false, 1);
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) + 45 - iScreenMove)) {
      m_oCanvas->DrawString(
          "WEB CODE", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 45 - iScreenMove, false, 1);
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) + 60 - iScreenMove)) {
      m_oCanvas->DrawString(
          "CREDITS", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 60 - iScreenMove, false, 1);
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) + 75 - iScreenMove)) {
      ...
      if (m_oCanvas->m_bFontBitmap && m_oCanvas->m_oImageArray[24] != nullptr) {
        ...
        m_oCanvas->DrawString(
            "DEFAULT", (m_oCanvas->m_iWidth / 2) + 10, (m_oCanvas->m_iHeight / 2) + 75 - iScreenMove, false, 2);
      }
    }
    if (45 <= ((m_oCanvas->m_iHeight / 2) + 90 - iScreenMove)) {
      m_oCanvas->DrawString(
          "SPEED:", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 90 - iScreenMove, false, 1);

      if (m_oCanvas->m_bSpeedOptimized) {
        m_oCanvas->DrawString(
            "ON", (m_oCanvas->m_iWidth / 2) + 10, (m_oCanvas->m_iHeight / 2) + 90 - iScreenMove, false, 2);
      } else {
        m_oCanvas->DrawString(
            "OFF", (m_oCanvas->m_iWidth / 2) + 10, (m_oCanvas->m_iHeight / 2) + 90 - iScreenMove, false, 1);
      }
    }
    m_oCanvas->DrawString(
        "MUSIC:", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 105 - iScreenMove, false, 1);

    if (m_oCanvas->m_oKaperApp->m_bSnd) {
      m_oCanvas->DrawString(
          "ON", (m_oCanvas->m_iWidth / 2) + 10, (m_oCanvas->m_iHeight / 2) + 105 - iScreenMove, false, 1);
    } else {
      m_oCanvas->DrawString(
          "OFF", (m_oCanvas->m_iWidth / 2) + 10, (m_oCanvas->m_iHeight / 2) + 105 - iScreenMove, false, 2);
    }

    m_oCanvas->DrawString(
        "QUIT", (m_oCanvas->m_iWidth / 2) - 40, (m_oCanvas->m_iHeight / 2) + 120 - iScreenMove, false, 1);
    ...
    // Arrows
    if ((m_iMenuY + iYOffSet) >= m_oCanvas->m_iHeight - 15) {
      iTempY = m_oCanvas->m_iHeight - 15;
      iYOffSet = 0;
    }
...
int StateMenu::Update() {
  if (!m_bShowHighscore && !m_bShowCredits && !m_bShowWebCode && !m_bShowInstructions) {
    ...
    // Key check
    if ((m_iMenuSelect & 0x80) == 0x80) {
      return (m_iMenuSelect - 0x80);
    }

    // SerialCode accepted
    if (m_sWebCode.compare("Accepted") == 0) {
      return 3;
    }
  }
...
void StateMenu::NormalButton(int iKey) {
  int keyState = 0;
  if (iKey != 128) {
  ...
  if ((m_bShowHighscore || m_bShowCredits || m_bShowInstructions || m_bShowWebHighscore) && iKey != 128) {
    if (m_bShowInstructions) {
      if (keyState == Canvas::DOWN) {
        if (m_cLineInstructions != 36) {
          m_cLineInstructions++;
        }
        return;
      }
      if (keyState == Canvas::UP) {
        if (m_cLineInstructions != 0) {
          m_cLineInstructions--;
        }
        return;
      }
    ...
    if (iKey == Canvas::KEY_NUM3 && m_iSubmitCodeStatus == 0) {
      ...
      Thread* commThread;
      SubmitWebScore tempVar(this);
      commThread = new Thread(&tempVar);
      commThread->start();
    ...
    if (keyState == Canvas::UP) {
      m_sWebCode = m_sWebCode.substr(0, m_iWebCodePos) +
        SwitchChar(m_sWebCode[m_iWebCodePos], true) +
        m_sWebCode.substr(m_iWebCodePos + 1);
    }

    if (keyState == Canvas::DOWN) {
      m_sWebCode = m_sWebCode.substr(0, m_iWebCodePos) +
        SwitchChar(m_sWebCode[m_iWebCodePos], false) +
        m_sWebCode.substr(m_iWebCodePos + 1);
    }
  ...
  if ((m_iKeyOldState & 4) == 0 && keyState == Canvas::UP) {
    if (m_iMenuSelect == 0) {
      m_iMenuSelect = 10;
      m_iMenuY = (m_oCanvas->m_iHeight / 2) + 123;
    } else if (m_iMenuSelect > 0) {
      m_iMenuSelect--;
    }
    m_iKeyOldState |= 4;
  }
  ...
  if (keyState == Canvas::FIRE) {
    ...
    if (m_iMenuSelect == 7) {
      if (m_oCanvas->m_bFontBitmap == true) {
        m_oCanvas->m_bFontBitmap = false;
      } else {
        m_oCanvas->m_bFontBitmap = true;
      }
    }
    if (m_iMenuSelect == 8) {
      if (m_oCanvas->m_bSpeedOptimized == true) {
    ...
    if (m_iMenuSelect == 9) {
      ...
      if (m_oCanvas != nullptr) {
        m_oCanvas->SoftButtonSND(m_oCanvas->m_oKaperApp->m_bSnd);
      }
    }
    if (m_iMenuSelect == 10) {
      m_oCanvas->ShutDown();
  ...
  if ((keyState != Canvas::DOWN)) {
    m_iKeyOldState &= (0xff - 8);
  }
  if ((keyState != Canvas::UP)) {
    m_iKeyOldState &= (0xff - 4);
  }
}

void StateMenu::LoadScore() {
  ...
  for (int i = 0; i < 5; i++) {
    ...
    m_sHighPlayers[i] = std::string(recordData.data(), 0, iLength);

    m_sHighPlayers[i] = "[" + std::to_string(i + 1) + "] " + m_sHighPlayers[i];

    recordData = std::vector<char>(nameRecord->getRecordSize((i * 2) + 2));
    iLength = nameRecord->getRecord((i * 2) + 2, recordData, 0);
    m_sHighScore[i] = std::string(recordData.data(), 0, iLength);
  }

  //----------------------------
  //---Close record
  //----------------------------
  recordData = std::vector<char>();
...
SubmitWebScore::SubmitWebScore(StateMenu* oFather) {
  m_oFather = oFather;
}

void SubmitWebScore::run() {
  try {
