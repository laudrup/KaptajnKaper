...
void CGameStateCity::Init() {
  ...
  if (((m_oCanvas->m_oStateGame->m_iShipX + 2) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenX == 10) {
    if (((m_oCanvas->m_oStateGame->m_iShipY) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenY == 12) {
      m_iFoodPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 2) + 1;
      m_iPiratePriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 5;
      m_iCannonPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 45;
  ...
  if (((m_oCanvas->m_oStateGame->m_iShipX + 2) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenX == 6) {
    if (((m_oCanvas->m_oStateGame->m_iShipY) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenY == 3) {
      m_iFoodPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 2) + 1;
      m_iPiratePriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 10;
      m_iCannonPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 50;
  ...
  if (((m_oCanvas->m_oStateGame->m_iShipX + 2) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenX == 24) {
    if (((m_oCanvas->m_oStateGame->m_iShipY) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenY == 11) {
      m_iFoodPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 2) + 3;
      m_iPiratePriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 25;
      m_iCannonPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 25;
      m_sCityName = "(K�benhavn)";
    }
  }
  ...
  if (((m_oCanvas->m_oStateGame->m_iShipX + 2) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenX == 24) {
    if (((m_oCanvas->m_oStateGame->m_iShipY) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenY == 6) {
      m_iFoodPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 2) + 3;
      m_iPiratePriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 20;
      m_iCannonPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 50;
      m_sCityName = "(Helsing�r)";
    }
  }
  ...
  if (((m_oCanvas->m_oStateGame->m_iShipX + 2) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenX == 17) {
    if (((m_oCanvas->m_oStateGame->m_iShipY) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenY == 7) {
      m_iFoodPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 2) + 2;
      m_iPiratePriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 10;
      m_iCannonPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 50;
  ...
  if (((m_oCanvas->m_oStateGame->m_iShipX + 2) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenX == 23) {
    if (((m_oCanvas->m_oStateGame->m_iShipY) / 25) + m_oCanvas->m_oStateGame->m_iMapScreenY == 2) {
      m_iFoodPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 2) + 4;
      m_iPiratePriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 15;
      m_iCannonPriceBuy = std::abs(m_oCanvas->m_oRand->nextInt() % 10) + 35;
...
void CGameStateCity::Draw(Graphics* g) {
  if (m_bLocked) {
    return;
  }
  ...
  m_oCanvas->DrawString(
      m_iAmount, (m_oCanvas->m_iWidth / 2) + 15, iYOffSet + (m_oCanvas->m_iHeight / 2) - 50, false, 1);
  ...
  m_oCanvas->DrawString(
      "Cannons", (m_oCanvas->m_iWidth / 2) - 40, iYOffSet + (m_oCanvas->m_iHeight / 2) - 15, false, 0);

  if (m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
    m_oCanvas->DrawString(
        "Ship L2", (m_oCanvas->m_iWidth / 2) - 40, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 0);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
    m_oCanvas->DrawString(
        "Ship L3", (m_oCanvas->m_iWidth / 2) - 40, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 0);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 3) {
    m_oCanvas->DrawString(
        "Ship L4", (m_oCanvas->m_iWidth / 2) - 40, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 0);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 4) {
    m_oCanvas->DrawString(
        "Ship L5", (m_oCanvas->m_iWidth / 2) - 40, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 0);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 5) {
    m_oCanvas->DrawString(
        "Ship L6", (m_oCanvas->m_iWidth / 2) - 40, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 0);
  }

  for (int i = 0; i < 4; i++) {
    m_oCanvas->DrawString(
        "<>", (m_oCanvas->m_iWidth / 2) + 7, iYOffSet + (m_oCanvas->m_iHeight / 2) - 35 + (i * 10), false, 0);
  }

  g->setColor(200, 200, 0);
  m_oCanvas->DrawString(
      m_iFoodPriceBuy, (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 35, false, 3);
  m_oCanvas->DrawString(
      m_iPiratePriceBuy, (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 25, false, 3);
  m_oCanvas->DrawString(
      m_iCannonPriceBuy, (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 15, false, 3);

  if (m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
    m_oCanvas->DrawString("150", (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 3);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
    m_oCanvas->DrawString("200", (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 3);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 3) {
    m_oCanvas->DrawString("400", (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 3);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 4) {
    m_oCanvas->DrawString("600", (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 3);
  }
  if (m_oCanvas->m_oStateGame->m_iShipLvl == 5) {
    m_oCanvas->DrawString("1500", (m_oCanvas->m_iWidth / 2) + 20, iYOffSet + (m_oCanvas->m_iHeight / 2) - 5, false, 3);
  }
  ...
  if (m_iTarget == 0) {
    ...
    g->drawImage(m_oCanvas->m_oImageArray[0],
                 (m_oCanvas->m_iWidth / 2) + 55 - 131,
                 iYOffSet + (m_oCanvas->m_iHeight / 2) - 45 + (m_iTarget * 10) - 63,
                 Graphics::TOP | Graphics::LEFT);
...
int CGameStateCity::SoftKey(int iKey) {
  if (m_bLocked) {
    return 0;
  }
  ...
  if (Canvas::KEY_NUM5 == iKey) {
    // Instant gold
    m_oCanvas->m_oStateGame->m_iResourceGold += m_oCanvas->m_oStateGame->m_iAddGold;
    m_oCanvas->m_oStateGame->m_iAddGold = 0;
    m_oCanvas->m_oStateGame->m_iResourceCorn += m_oCanvas->m_oStateGame->m_iAddFood;
    m_oCanvas->m_oStateGame->m_iAddFood = 0;
    m_oCanvas->m_oStateGame->m_iResourceCannon += m_oCanvas->m_oStateGame->m_iAddCannons;
    m_oCanvas->m_oStateGame->m_iAddCannons = 0;
    m_oCanvas->m_oStateGame->m_iResourcePirate += m_oCanvas->m_oStateGame->m_iAddPirates;
    m_oCanvas->m_oStateGame->m_iAddPirates = 0;
  }

  if (!(m_oCanvas->m_oStateGame->m_iAddFood == 0 && m_oCanvas->m_oStateGame->m_iAddGold == 0 &&
        m_oCanvas->m_oStateGame->m_iAddPirates == 0 && m_oCanvas->m_oStateGame->m_iAddCannons == 0)) {
    return 0;
  }
  ...
  if (keyState == Canvas::LEFT) // Sell
  {
    ...
    if (m_iTarget == 1) // Grain
    {
      if (m_oCanvas->m_oStateGame->m_iResourceCorn < m_iAmount) {
        return 0;
      }
    ...
    if (m_iTarget == 2) // Kapers
    {
      if (m_oCanvas->m_oStateGame->m_iResourcePirate < m_iAmount) {
        return 0;
      }
    ...
    if (m_iTarget == 3) // Cannons
    {
      if (m_oCanvas->m_oStateGame->m_iResourceCannon < m_iAmount) {
        return 0;
      }
    ...
    if (m_iTarget == 4) // Ship
    {
      if (m_oCanvas->m_oStateGame->m_iShipLvl == 6) {
        if (m_oCanvas->m_oStateGame->m_iResourceCorn > 500) {
          m_iBlink = 20;
          m_cTarget = 1;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourcePirate > 350) {
          m_iBlink = 20;
          m_cTarget = 2;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourceCannon > 100) {
          m_iBlink = 20;
          m_cTarget = 3;
          return 0;
        }
        ...
        if (m_oCanvas->m_oStateGame->m_iResourceCorn > 400) {
          m_iBlink = 20;
          m_cTarget = 1;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourcePirate > 200) {
          m_iBlink = 20;
          m_cTarget = 2;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourceCannon > 60) {
          m_iBlink = 20;
          m_cTarget = 3;
          return 0;
        }
        ...
        if (m_oCanvas->m_oStateGame->m_iResourceCorn > 300) {
          m_iBlink = 20;
          m_cTarget = 1;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourcePirate > 100) {
          m_iBlink = 20;
          m_cTarget = 2;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourceCannon > 30) {
          m_iBlink = 20;
          m_cTarget = 3;
          return 0;
        }
        ...
        if (m_oCanvas->m_oStateGame->m_iResourceCorn > 200) {
          m_iBlink = 20;
          m_cTarget = 1;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourcePirate > 50) {
          m_iBlink = 20;
          m_cTarget = 2;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourceCannon > 15) {
          m_iBlink = 20;
          m_cTarget = 3;
          return 0;
        }
        ...
        if (m_oCanvas->m_oStateGame->m_iResourceCorn > 100) {
          m_iBlink = 20;
          m_cTarget = 1;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourcePirate > 35) {
          m_iBlink = 20;
          m_cTarget = 2;
          return 0;
        }
        if (m_oCanvas->m_oStateGame->m_iResourceCannon > 7) {
          m_iBlink = 20;
          m_cTarget = 3;
          return 0;
        }
  ...
  if (keyState == Canvas::RIGHT) // Buy
  {
    ...
    if (m_iTarget == 1) // Grain
    {
      if (m_oCanvas->m_oStateGame->m_iResourceGold >= (m_iFoodPriceBuy * m_iAmount)) {
        if (100 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) && m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
          ...
          if (100 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
            return 0;
          }
        }
        if (200 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) && m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
          ...
          if (200 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
            return 0;
          }
        }
        if (300 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) && m_oCanvas->m_oStateGame->m_iShipLvl == 3) {
          ...
          if (300 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
            return 0;
          }
        }
        if (400 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) && m_oCanvas->m_oStateGame->m_iShipLvl == 4) {
          ...
          if (400 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
            return 0;
          }
        }
        if (500 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) && m_oCanvas->m_oStateGame->m_iShipLvl == 5) {
          ...
          if (500 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCorn) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
            return 0;
          }
        }
    ...
    if (m_iTarget == 2) // Kapers
    {
      if (m_oCanvas->m_oStateGame->m_iResourceGold >= (m_iPiratePriceBuy * m_iAmount)) {
        if (35 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) && m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
          ...
          if (35 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
            return 0;
          }
        }
        if (50 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) && m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
          ...
          if (50 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
            return 0;
          }
        }
        if (100 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) &&
            m_oCanvas->m_oStateGame->m_iShipLvl == 3) {
        ...
        if (200 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) &&
            m_oCanvas->m_oStateGame->m_iShipLvl == 4) {
        ...
        if (350 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourcePirate) &&
            m_oCanvas->m_oStateGame->m_iShipLvl == 5) {
    ...
    if (m_iTarget == 3) // Cannons
    {
      if (m_oCanvas->m_oStateGame->m_iResourceGold >= (m_iCannonPriceBuy * m_iAmount)) {
        if (7 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) && m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
          ...
          if (7 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 1) {
            return 0;
          }
        }
        if (15 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) && m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
          ...
          if (15 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 2) {
            return 0;
          }
        }
        if (30 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) && m_oCanvas->m_oStateGame->m_iShipLvl == 3) {
          ...
          if (30 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 3) {
            return 0;
          }
        }
        if (60 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) && m_oCanvas->m_oStateGame->m_iShipLvl == 4) {
          ...
          if (60 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) &&
              m_oCanvas->m_oStateGame->m_iShipLvl == 4) {
            return 0;
          }
        }
        if (100 < (m_iAmount + m_oCanvas->m_oStateGame->m_iResourceCannon) &&
            m_oCanvas->m_oStateGame->m_iShipLvl == 5) {
    ...
    if (m_iTarget == 4) // Ship
    {
      if (m_oCanvas->m_oStateGame->m_iShipLvl == 5 && m_oCanvas->m_oStateGame->m_iResourceGold >= 1500) {
        m_oCanvas->m_oStateGame->m_iAddGold = -1500;
      } else if (m_oCanvas->m_oStateGame->m_iShipLvl == 4 && m_oCanvas->m_oStateGame->m_iResourceGold >= 600) {
        m_oCanvas->m_oStateGame->m_iAddGold = -600;
      } else if (m_oCanvas->m_oStateGame->m_iShipLvl == 3 && m_oCanvas->m_oStateGame->m_iResourceGold >= 400) {
        m_oCanvas->m_oStateGame->m_iAddGold = -400;
      } else if (m_oCanvas->m_oStateGame->m_iShipLvl == 2 && m_oCanvas->m_oStateGame->m_iResourceGold >= 200) {
        m_oCanvas->m_oStateGame->m_iAddGold = -200;
      } else if (m_oCanvas->m_oStateGame->m_iShipLvl == 1 && m_oCanvas->m_oStateGame->m_iResourceGold >= 150) {
        m_oCanvas->m_oStateGame->m_iAddGold = -150;
      } else {
        return 0;
      }
